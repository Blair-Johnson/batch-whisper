...
Long-form batch processing in whisper is now supported in [HuggingFace Transformers](https://github.com/huggingface/transformers/pull/27658). Please use that version if you need this feature as it has ongoing support and additional optimizations over the base whisper implementation (which this repo is based on).
